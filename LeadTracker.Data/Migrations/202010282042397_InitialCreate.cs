    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Reps", t => t.RepID, cascadeDelete: true)
                .Index(t => t.LeadID)
                .Index(t => t.RepID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Interactions", "RepID", "dbo.Reps");
            DropForeignKey("dbo.Interactions", "LeadID", "dbo.Leads");
            ...
            DropIndex("dbo.Interactions", new[] { "RepID" });
            DropIndex("dbo.Interactions", new[] { "LeadID" });
